...
predUnit = linear1Layer.predLinearUnit().cpu()
...
for vidNum in range(1,1500):
	...
	for n in range(0,d-1):
		...
		frame_t0 = frame_t0.view(1, fHeight*fHeight)
		frame_t1 = frame_t1.view(1, fHeight*fHeight)
...
torch.save(predUnit, 'linear1Layer.pt')
